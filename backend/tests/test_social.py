...
from backend.routes.social import get_splitwise_client
...
def test_find_common_groups(mock_splitwise_client):
    ...
    response = client.get("/find_common_groups?token=test_token&participants=1,2")
...
def test_find_common_groups_no_match(mock_splitwise_client):
    ...
    response = client.get("/find_common_groups?token=test_token&participants=1,3")
